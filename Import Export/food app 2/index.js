...
function append(data){
    ...
    data.forEach(el => {
        ...
        if(el.strIngredient2==null || el.strIngredient2==null){
            ...
            ap.innerText=`${el.strIngredient2} : ${el.strMeasure2}`
        }
        ...
        if(el.strIngredient4==null || el.strIngredient4==null){
            ...
            mp.innerText=`${el.strIngredient4} : ${el.strMeasure4}`
        }
        ...
        if(el.strIngredient8==null || el.strIngredient8==null){
            ...
            cd.innerText=`${el.strIngredient8} : ${el.strMeasure8}`
        }
        ...
        let ap0=document.createElement("p")
        if(el.strIngredient20==null || el.strIngredient20==null){
            ...
            ap0.innerText=`${el.strIngredient20} : ${el.strMeasure20}`
        }
        ...
        sdiv.append(s1,ap,s3,mp,s5,s6,s7,cd,s9,s10,s11,s12,s13,s14,s15,s16,s17,s18,s19,ap0)
         divcl.append(cat,loc,iframe)
        div.append(title,imag,divcl)
